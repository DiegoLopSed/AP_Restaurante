<?php
/**
 * API REST para login de clientes frecuentes
 * 
 * Endpoint encargado de autenticar clientes dentro del programa
 * de lealtad del sistema. Permite iniciar sesión utilizando
 ...
 * - Soporte para CORS (peticiones externas)
 * 
 * Características:
 * - Manejo de preflight (OPTIONS)
 * - Control de errores centralizado
 * - Uso de buffer de salida para respuestas limpias
 * - Delegación de lógica al ClienteController
 * 
 * @package AP_Restaurante
 * @subpackage ClienteLoginAPI
