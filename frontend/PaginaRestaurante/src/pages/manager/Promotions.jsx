      ...
      <header className={styles.header}>
        <div>
          ...
          <p className={styles.subtitle}>
            Descubre las promociones activas y beneficios disponibles para ti como cliente frecuente.
          </p>
        </div>
        ...
        <div className={styles.grid}>
          {promotions.map((promo) => (
            <article key={promo.id} className={styles.card}>
                ...
                <div className={styles.cardTitleGroup}>
                  ...
                  <span
                    className={`${styles.status} ${
                      promo.estado === 'Activa' ? styles.statusActive : styles.statusDraft
                    }`}
                  >
                    {promo.estado}
                  </span>
              ...
              <p className={styles.cardDescription}>{promo.descripcion}</p>
              <div className={styles.cardFooter}>
                <span className={styles.vigencia}>{promo.vigencia}</span>
