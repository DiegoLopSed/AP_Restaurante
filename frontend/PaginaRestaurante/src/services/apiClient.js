...
function resolveApiBase() {
  ...
  // Reemplazar el último segmento "app/" por "backend/api/"
  if (normalized.endsWith('app/')) return normalized.replace(/app\/$/, 'backend/api');

  // Fallback (por si cambian la estructura)
  return '/AP_Restaurante/backend/api';
}
